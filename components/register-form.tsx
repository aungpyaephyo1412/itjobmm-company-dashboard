    ...
    return (
        <form onSubmit={(e) => {
            ...
            <div className="grid grid-cols-2 gap-5">
                <Input errorMessage={validationErrors?.name?.[0]} label="Name" name="name" onChange={handleInputChange}
                       isInvalid={!!validationErrors?.name}/>
                <Input errorMessage={validationErrors?.phone?.[0]} label="Phone" name="phone" onChange={handleInputChange}
                       isInvalid={!!serverError || !!validationErrors?.phone}/>
            </div>
            <div className="grid grid-cols-2 gap-5">
                <Input errorMessage={validationErrors?.email?.[0]} label="Email" name="email" onChange={handleInputChange}
                       isInvalid={!!serverError || !!validationErrors?.email}/>
                <Input label="Username" name="username" onChange={handleInputChange}
                       errorMessage={validationErrors?.username?.[0]}
                       isInvalid={!!serverError || !!validationErrors?.username}/>
            </div>
            <div className="grid grid-cols-2 gap-5">
                <Input errorMessage={validationErrors?.type?.[0]} label="Type" name="type" onChange={handleInputChange}
                       isInvalid={!!validationErrors?.type}/>
                <Input label="Industry" name="Industry" onChange={handleInputChange}
            ...
            />
            <Input label="No Of Employees" name="noOfEmployees" onChange={handleInputChange}
